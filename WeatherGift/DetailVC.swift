...
extension DetailVC: CLLocationManagerDelegate {
    ...
    func handleLocationAuthorizationStatus(status: CLAuthorizationStatus) {
        ...
        case .denied:
            showAlertToPrivacySettings(title: "User has not authorized Location services", message: "Select 'Settings' below to open device settings to enable location settings")
        case .restricted:
    ...
    func showAlertToPrivacySettings(title: String, message: String) {
        ...
        guard let settingsURL = URL(string: UIApplicationOpenSettingsURLString) else {
            print("Something went wrong getting the Settings URL String")
            return
        }
